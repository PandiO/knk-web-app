...
export const SortableSectionItem: React.FC<Props> = ({ section, index, isSelected, onSelect, onDelete }) => {
    const {
        attributes,
        listeners,
        setNodeRef,
        transform,
        transition,
    } = useSortable({ id: section.sectionGuid || section.id! });
    ...
    return (
        <div
            ...
            className={`flex items-center p-3 border rounded-md cursor-pointer ${
                section.hasCompatibilityIssues
