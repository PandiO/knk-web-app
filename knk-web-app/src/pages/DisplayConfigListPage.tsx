...
export const DisplayConfigListPage: React.FC = () => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="bg-white shadow-sm rounded-lg">
                    <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Display Builder Entities</h1>
                            <p className="mt-1 text-sm text-gray-500">
                                Entities available for display configuration
                            </p>
                        </div>
                        <button
                            onClick={() => navigate('/admin/display-configurations/new')}
                    ...
                    <div className="px-6 py-4">
                        {entityMetadata.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                    No display-configurable entities were returned.
                                </p>
                            </div>
                        ) : (
                                ...
                                {entityMetadata.map(em => (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2">
                                            <button
                                                onClick={() => navigate(`/admin/display-configurations/new?entity=${encodeURIComponent(em.entityName)}`)}
                                                className="w-full btn-primary text-sm"
                                            >
                                                Configure Display
                                            </button>
                                            <button
                                                onClick={() => navigate(`/admin/display-configurations/new?entity=${encodeURIComponent(em.entityName)}&default=true`)}
